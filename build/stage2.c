...
int main(){
    ...
    generate_code("build/stage3/c","build/stage3/c","silverchain_stage3",tags,true,DEFAULT_MAIN_C_NAME,NULL);

    CTextStack *final_compilation_linux = stack.newStack_string_format("gcc build/stage3/c/main.c -o %s",FINAL_OUPTUT_LINUX);
